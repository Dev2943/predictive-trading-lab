...
enum class TimeInForce : std::uint8_t {
    Day,
    ImmediateOrCancel,
    /// All-or-nothing, immediately. Distinct from IOC: an IOC takes whatever is
    /// available and cancels the rest, whereas an FOK that cannot be filled in
    /// FULL fills nothing at all. Conflating them understates execution risk on
